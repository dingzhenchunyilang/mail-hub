<template>
  <div class="relative h-[100dvh] overflow-hidden bg-paper text-ink">
    ...
    <main class="h-[100dvh] overflow-y-auto lg:ml-72">
      <div class="min-h-full p-3 lg:p-3.5 lg:pl-0">
        <div class="surface-panel min-h-full">
          <router-view />
        </div>
      </div>
    </main>
...
const mailNav = [
  ...
  { to: '/trash', label: '回收站', icon: 'M3 6h18M8 6V4.5A1.5 1.5 0 019.5 3h5A1.5 1.5 0 0116 4.5V6m-10.5 0 .75 14.25A1.5 1.5 0 007.747 21h8.506a1.5 1.5 0 001.497-.75L18.5 6M10 10v7m4-7v7' },
